...
export default function MapPicker({
  ...
  return (
    <div className="space-y-4">
      {/* Map Display */}
      <div className={`relative w-full h-80 rounded-2xl overflow-hidden border-2 border-slate-200 bg-gradient-to-br from-blue-100 to-green-100 ${
        ...
        <svg viewBox="0 0 600 400" className="w-full h-full">
          ...
          {/* Center point marker */}
          <circle cx="300" cy="200" r="8" fill="#ef4444" stroke="#fff" strokeWidth="2" />
          <circle cx="300" cy="200" r="12" fill="none" stroke="#ef4444" strokeWidth="1" opacity="0.5" />
          <circle cx="300" cy="200" r="16" fill="none" stroke="#ef4444" strokeWidth="1" opacity="0.3" />
          
          {/* Crosshair */}
          <line x1="300" y1="10" x2="300" y2="390" stroke="#cbd5e1" strokeWidth="0.5" strokeDasharray="5" />
          <line x1="10" y1="200" x2="590" y2="200" stroke="#cbd5e1" strokeWidth="0.5" strokeDasharray="5" />
        </svg>
        ...
        <div className="absolute top-4 left-4 bg-white/95 px-4 py-3 rounded-xl shadow-lg text-sm font-bold text-slate-700 backdrop-blur-sm">
          <div className="text-xs text-slate-500 font-semibold mb-1">Koordinat</div>
      ...
      <p className="text-xs text-slate-500 italic">
        💡 Gunakan tombol "Gunakan Lokasi Saya Sekarang" untuk mengambil lokasi GPS saat ini, atau masukkan koordinat secara manual dengan presisi hingga 6 desimal.
      </p>
    </div>
  );
}
